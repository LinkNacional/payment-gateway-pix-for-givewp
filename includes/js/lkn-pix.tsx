    ...
    Fields() {
        return (
            <div style={{ textAlign: 'center', maxWidth: '400px' }}>
                <h3>Chave Pix:</h3>
                <p id='qr'>
                    <img src={'https://chart.googleapis.com/chart?cht=qr&chs=150x150&chl=' + encodeURIComponent(pixBuilder(lknAttr.pixType, lknAttr.pixKey, lknAttr.pixName, lknAttr.pixCity, amount))} alt={'QR Code for ' + pixBuilder(lknAttr.pixType, lknAttr.pixKey, lknAttr.pixName, lknAttr.pixCity, amount)} />
                </p>
                <p id='pix'>
                    {pixBuilder(lknAttr.pixType, lknAttr.pixKey, lknAttr.pixName, lknAttr.pixCity, amount)}
                </p>
                <p id='copy-pix'>
                    <button type="button" class="copy-button" onClick={writeToClipboard}>Copiar a Chave</button>
                </p>
            </div>
        )
    }
