                ...
                <div id="lkn-pix-form-donation"  >
                    ...
                    <div className='pix-container'>
                        ...
                        <div style={{ display: "flex" }}>
                            ...
                            <button id="toggle-viewing" type="button" title={__('Copy Pix', 'payment-gateway-pix-for-givewp')} style={{ width: "30%", background: "black", color: "white", fontWeight: "900" }} onClick={() => {
